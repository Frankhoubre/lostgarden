...
export const aiAnimeArticleKo: AiAnimeArticle = {
  ...
  entries: [
    {
      ...
      paragraphs: [
        "솔은 지하 제단에서 깨어납니다. 기억은 없고, 얼굴이 있어야 할 자리에는 등불이 있습니다. 로즈는 이유도 모른 채 그가 지키기로 한 아이입니다. 두 사람 주위에는 푸른 숲과 청록빛 안개, 그리고 오래된 맹세에 묶인 열세 명의 텅 빈 기사가 있는 묻힌 세계가 펼쳐집니다.",
  ...
  productionParagraphs: [
    ...
    "이미지와 영상 생성은 Imaginode에서 돌아갑니다. Frank Houbre가 직접 만든 AI 창작 플랫폼으로, 많은 이미지 모델과 영상 모델을 하나의 노드 캔버스 뒤에 모아둡니다. 덕분에 도구를 바꾸지 않고 같은 컷을 여러 모델로 시험할 수 있고, 캐릭터 레퍼런스가 그것을 쓰는 컷 옆에 그대로 남습니다. 이건 어떤 모델을 고르느냐보다 중요합니다. 솔의 갑옷과 로즈의 얼굴을 한 편 내내 안정적으로 유지하는 건 프롬프트 문제가 아니라 파이프라인 문제이기 때문입니다.",
