  ...
  sections: [
    ...
    },
    {
      ...
      trailingParagraphs: [
        ...
        "Lost Gardenでは、これらのカットをScreenWeaverのワークフローと制作インターフェースの中で制作しています。各カットは脚本から生成された絵コンテまで、自分のシーンとつながったまま保たれます。だから何十ものばらばらなファイルの間で迷うことがありません。Solの目覚め、開く眼、彼を持ち上げるソースツリー、そのすべてが同じ元のテキストから始まり、そこへ戻っていきます。",
        "それは簡単だという意味ではありません。",
