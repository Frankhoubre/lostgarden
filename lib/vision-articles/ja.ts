  ...
  sections: [
    {
      paragraphs: [
        ...
        "Lost Gardenの核にあるのは、ランタン型の兜をかぶった空っぽの鎧、Lanterneと、傷ついた世界の再生と結びついた謎の子供、Roseについてのダークファンタジーです。物語は、青い森、光るキノコ、巨大な根、奇妙な機械、古代の洞窟、静かな巡礼者、記憶より古く見える忘れられた存在で満ちた、広大な地下世界が舞台です。",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "アイデア、キャラクター、感情の方向性、世界、トーン、物語の選択、LanterneとRoseの関係、それらすべては人間の意図から生まれます。AIは、それらのアイデアを、これまでよりはるかに速く、画像、シーン、アニメーションテスト、音楽の方向性、制作素材に変える手助けをします。",
      ...
      trailingParagraphs: [
        "具体的には、Lost Gardenのすべては私が作ったクリエイティブツールScreenWeaverの中にあります。私はそこで脚本を手書きで執筆します。脚本を唯一の正本として保つ本格的な執筆環境が、大きな作業の快適さを与えてくれます。その脚本からScreenWeaverが絵コンテをシーンごとに全面生成し、私は元のテキストとのつながりを失わないまま、すべてのカットをそのワークフローと制作インターフェースで制作します。",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Lanterneには、一目でわかるデザインが必要でした。古い空洞の鎧、ランタン型の兜、本当の顔がない、中に体がない、控えめなプロポーション、脆くて少しぎこちない態度。伝説の強大な騎士ではありません。傷つき、詩的で、不器用で、守ろうとする存在です。",
        "Roseには逆のエネルギーが必要でした。小さな子供、柔らかく、無垢で、穏やかで、静かな感情的な強さを持つ。世界に利用されそうな存在でありながら、ただ子供であるという理由だけで守られるべき存在に感じさせたい。",
        "キャラクターシートは、シーンごとにキャラクターの一貫性を保つのに役立ちます。正面、横、クRoseアップ、態度の参考、衣装の参考、感情の参考。これがないと、AI生成のアニメはすぐに不整合になります。顔が変わり、衣装が変わり、プロポーションがずれます。",
    ...
    },
    {
      ...
      list: [
        "青い洞窟の石の祭壇で目覚めるLanterne。",
        "中が空であることを発見するLanterne。",
        "足下で開く巨大な異星の目。",
        "一斉にこちらを向く仮面の巡礼者たち。",
        "夢の中、白いユリの丘に立つRose。",
        "Lanterneを優しく手に乗せるソースツリー。",
      ...
      trailingParagraphs: [
        ...
        "Lost Gardenでは、これらのカットをScreenWeaverのワークフローと制作インターフェースの中で制作しています。各カットは脚本から生成された絵コンテまで、自分のシーンとつながったまま保たれます。だから何十ものばらばらなファイルの間で迷うことがありません。Lanterneの目覚め、開く眼、彼を持ち上げるソースツリー、そのすべてが同じ元のテキストから始まり、そこへ戻っていきます。",
        "それは簡単だという意味ではありません。",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "例えばLanterneがソースツリーに会うとき、音楽は英雄的であってはなりません。古く、圧倒的に感じるべきです。柔らかいガラス音、低いチェロ、言葉のない合唱のテクスチャ、洞窟のリバーブ、木の根のきしみ、かすかな鎧の金属共鳴。",
        "異星の機械が目覚めるとき、音はよりSF的になります。冷たいドローン、電気のパチパチ、機械のうめき、アラームのような音、そして特徴的なエイリアンの叫び。",
        "Lanterne自身にも音のアイデンティティがあります。本当の人間の声はありません。空洞で男性的な金属鎧の音を出します。きしみ、空の息、内部の共鳴、小さな苛立ちのうめき、奇妙な金属のため息。",
