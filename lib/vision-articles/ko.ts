  ...
  sections: [
    {
      paragraphs: [
        ...
        "Lost Garden의 핵심은 랜턴 모양 투구를 쓴 빈 갑옷 Lanterne와, 상처 입은 세계의 재탄생과 연결된 신비한 아이 Rose에 관한 다크 판타지입니다. 이야기는 푸른 숲, 빛나는 버섯, 거대한 뿌리, 기이한 기계, 고대 동굴, 조용한 순례자, 기억보다 오래된 듯한 잊힌 존재들로 가득한 광대한 지하 세계에서 펼쳐집니다.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "아이디어, 캐릭터, 감정의 방향, 세계, 톤, 이야기 선택, Lanterne와 Rose의 관계, 이 모든 것은 인간의 의도에서 나옵니다. AI는 그 아이디어를 이전보다 훨씬 빠르게 이미지, 장면, 애니메이션 테스트, 음악 방향, 제작 자료로 바꾸는 데 도움을 줍니다.",
      ...
      trailingParagraphs: [
        "구체적으로 Lost Garden의 모든 것은 제가 만든 창작 도구 ScreenWeaver 안에 있습니다. 저는 그곳에서 각본을 직접 집필합니다. 각본을 유일한 기준으로 유지하는 본격적인 집필 환경이 작업을 매우 편안하게 해줍니다. 그 각본을 바탕으로 ScreenWeaver가 스토리보드를 장면별로 전부 생성하고, 저는 원본 텍스트와의 연결을 잃지 않은 채 모든 컷을 그 워크플로 및 제작 인터페이스로 제작합니다.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Lanterne에게는 한눈에 알아볼 수 있는 디자인이 필요했습니다. 오래된 빈 갑옷, 랜턴형 투구, 진짜 얼굴 없음, 안의 몸 없음, 소박한 비율, 연약하고 약간 어색한 태도. 강력한 전설의 기사가 아닙니다. 상처 입었고, 시적이며, 서툴고, 지키려는 존재입니다.",
        "Rose에게는 반대 에너지가 필요했습니다. 작은 아이, 부드럽고, 순수하며, 고요하고, 조용한 감정적 힘. 세계가 이용하려 하는 존재이면서, 단지 아이이기 때문에 보호받아야 하는 존재로 느껴져야 했습니다.",
        "캐릭터 시트는 장면마다 캐릭터의 일관성을 유지하는 데 도움이 됩니다. 정면, 측면, 클Rose업, 태도 참고, 의상 참고, 감정 참고. 없으면 AI 생성 애니는 금세 불일치합니다. 얼굴이 바뀌고, 의상이 바뀌고, 비율이 흐트러집니다.",
    ...
    },
    {
      ...
      list: [
        "푸른 동굴의 돌 제단에서 깨어나는 Lanterne.",
        "안이 비어 있음을 발견하는 Lanterne.",
        "발밑에서 열리는 거대한 외계의 눈.",
        "한꺼번에 그를 향하는 가면 순례자들.",
        "꿈속 흰 백합 언덕에 선 Rose.",
        "Lanterne를 부드럽게 손에 올리는 소스 트리.",
        "땅에서 피어나 소스 차일드를 낳는 거대한 장미.",
      ],
      trailingParagraphs: [
        "몇 년 전이었다면, 이런 장면을 시제작하려면 큰 애니 팀, 스튜디오 파이프라인, 많은 비용이 필요했을 것입니다.",
        "이제 강한 아이디어를 가진 크리에이터는 혼자 또는 아주 작은 팀으로 비주얼 시퀀스를 만들기 시작할 수 있습니다.",
        "Lost Garden에서는 이 컷들을 ScreenWeaver의 워크플로 및 제작 인터페이스 안에서 제작합니다. 각 컷은 각본에서 생성된 스토리보드까지 자신의 장면과 연결된 채 유지되므로, 수십 개의 흩어진 파일 사이에서 길을 잃지 않습니다. Lanterne의 깨어남, 열리는 눈, 그를 들어 올리는 소스 트리, 그 모든 것이 같은 원본 텍스트에서 시작해 그곳으로 돌아갑니다.",
        "쉽다는 뜻은 아닙니다.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "예를 들어 Lanterne가 소스 트리를 만날 때, 음악은 영웅적이어서는 안 됩니다. 고대적이고 압도적으로 느껴져야 합니다. 부드러운 유리음, 낮은 첼로, 가사 없는 합창 텍스처, 동굴 리버브, 나무 뿌리 삐걱임, 희미한 갑옷 금속 공명.",
        "외계 기계가 깨어날 때는 더 SF적으로: 차가운 드론, 전기 찌릿임, 기계적 신음, 알람 같은 톤, 시그니처 외계 비명.",
        "Lanterne 자신도 사운드 정체성이 있습니다. 진짜 인간 목소리는 없습니다. 속이 빈 남성적 금속 갑옷 소리를 냅니다. 삐걱임, 빈 숨, 내부 공명, 작은 짜증의 신음, 이상한 금속 한숨.",
