  ...
  sections: [
    ...
    },
    {
      ...
      trailingParagraphs: [
        ...
        "Lost Garden에서는 이 컷들을 ScreenWeaver의 워크플로 및 제작 인터페이스 안에서 제작합니다. 각 컷은 각본에서 생성된 스토리보드까지 자신의 장면과 연결된 채 유지되므로, 수십 개의 흩어진 파일 사이에서 길을 잃지 않습니다. Sol의 깨어남, 열리는 눈, 그를 들어 올리는 소스 트리, 그 모든 것이 같은 원본 텍스트에서 시작해 그곳으로 돌아갑니다.",
        "쉽다는 뜻은 아닙니다.",
