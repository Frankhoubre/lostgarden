...
export const VISION_ARTICLE = {
  pageTitle: "Vision",
  headline: "Creating an Anime With AI, One Scene at a Time",
  description:
    "Frank Houbre on Lost Garden: Sol, Rose, a wounded underground world, and how AI helps turn a clear artistic vision into images, animation, and sound.",
  sections: [
    {
      paragraphs: [
  ...
  ] satisfies readonly VisionSection[],
} as const;
