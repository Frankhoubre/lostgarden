...
export const processArticleKo: VisionArticle = {
  ...
  sections: [
    ...
    },
    {
      heading: "제작 파이프라인 (요약)",
      list: [
        "각본: ScreenWeaver에서 직접 집필. 각본을 유일한 기준으로 유지하며 집필이 매우 편안합니다.",
        "스토리, 캐릭터, 톤, 편집 선택: 인간 감독.",
        "스토리보드: 각본을 바탕으로 ScreenWeaver가 장면별로 전부 생성.",
        "캐릭터 시트와 비주얼 바이블: 참조 아트 후 AI 반복으로 일관성.",
        "배경과 소품: 지하 세계 바이블에 맞춘 프롬프트.",
        "컷 제작: ScreenWeaver의 워크플로 및 제작 인터페이스로 진행. 이미지·비디오 생성이 각본 문맥과 연결된 채로 유지됩니다(버전과 반복).",
    ...
    },
    {
      heading: "도구와 모델",
      paragraphs: [
        "제작의 중심축은 Frank Houbre가 직접 만든 창작 도구 ScreenWeaver입니다. 각본 집필, 스토리보드 생성, 컷 제작이 각본 문맥을 기점으로 한 공간에서 연결됩니다.",
        "이미지·비디오 스택은 모델 발전에 따라 갱신됩니다. 최신 모델(모션 테스트에 Seedance 2 등)과 일반 편집을 병행합니다. 한 모델이 전편을 만든 것이 아니며, 감독과 선별이 더 중요합니다.",
      ],
    },
    {
      heading: "저작권과 오리지널리티",
