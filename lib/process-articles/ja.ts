...
export const processArticleJa: VisionArticle = {
  ...
  sections: [
    ...
    },
    {
      heading: "制作パイプライン（概要）",
      list: [
        "脚本：ScreenWeaver上で手書きで執筆。脚本を唯一の正本として保ち、快適に書ける環境です。",
        "ストーリー・キャラ・トーン・編集判断：人間のディレクション。",
        "絵コンテ：脚本からScreenWeaverがシーンごとに全面生成。",
        "キャラクターシートとビジュアルバイブル：参照画とAI反復で一貫性を確保。",
        "背景・小道具：地下世界のバイブルに沿ったプロンプト。",
        "カット制作：ScreenWeaverのワークフローと制作インターフェースで実施。画像・動画生成は脚本の文脈とつながったまま（バージョンと反復）。",
    ...
    },
    {
      heading: "ツールとモデル",
      paragraphs: [
        "制作の背骨はFrank Houbre自身のクリエイティブツールScreenWeaverです。脚本の執筆、絵コンテの生成、カットの制作が、脚本の文脈を起点に一つの場でつながっています。",
        "画像・動画スタックはモデルの進化に合わせて更新されます。現行モデル（モーションテストにSeedance 2など）と従来の編集を併用しています。一つのモデルが全編を作ったわけではなく、ディレクションと選別が重要です。",
      ],
    },
    {
      heading: "著作権とオリジナリティ",
