...
const SLUG = "/lost-garden-story-and-characters" as const;
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return buildPageMetadata({
    locale,
    title: dict.meta.lostGardenStoryAndCharacters.title,
    description: dict.meta.lostGardenStoryAndCharacters.description,
...
export default async function LostGardenStoryAndCharactersPage({ params }: PageProps) {
  const { locale: localeParam } = await params;
