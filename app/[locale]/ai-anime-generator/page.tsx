...
const SLUG = "/ai-anime-generator" as const;
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return buildPageMetadata({
    locale,
    title: dict.meta.aiAnimeGenerator.title,
    description: dict.meta.aiAnimeGenerator.description,
...
export default async function AiAnimeGeneratorPage({ params }: PageProps) {
  const { locale: localeParam } = await params;
  ...
  const media = getArticleMedia(SLUG);
  const page = dict.guides.aiAnimeGenerator;
