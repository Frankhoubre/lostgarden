...
const SLUG = "/ai-anime-storyboard" as const;
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return buildPageMetadata({
    locale,
    title: dict.meta.aiAnimeStoryboard.title,
    description: dict.meta.aiAnimeStoryboard.description,
...
export default async function AiAnimeStoryboardPage({ params }: PageProps) {
  const { locale: localeParam } = await params;
  ...
  const media = getArticleMedia(SLUG);
  const page = dict.guides.aiAnimeStoryboard;
