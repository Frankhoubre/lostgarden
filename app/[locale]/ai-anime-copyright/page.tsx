...
const SLUG = "/ai-anime-copyright" as const;
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return buildPageMetadata({
    locale,
    title: dict.meta.aiAnimeCopyright.title,
    description: dict.meta.aiAnimeCopyright.description,
...
export default async function AiAnimeCopyrightPage({ params }: PageProps) {
  const { locale: localeParam } = await params;
  ...
  const media = getArticleMedia(SLUG);
  const page = dict.guides.aiAnimeCopyright;
